...
# example command line: ./map_modern_PE.sh $1 $2 $3 $4
...
Mismatch=0.04	# Mismatch threshold
...
$softdir/bwa aln -n $Mismatch -t $threads ../refgenomes/$2/*.fa ../mapped$2/$1+$4_$2_map_processing/$1+$4_mappable_R1.fastq > ../mapped$2/$1+$4_$2_map_processing/$1+$4_r1.sai
$softdir/bwa aln -n $Mismatch -t $threads ../refgenomes/$2/*.fa ../mapped$2/$1+$4_$2_map_processing/$1+$4_mappable_R2.fastq > ../mapped$2/$1+$4_$2_map_processing/$1+$4_r2.sai
$softdir/bwa sampe -a $max_insert ../refgenomes/$2/*.fa ../mapped$2/$1+$4_$2_map_processing/$1+$4_r1.sai ../mapped$2/$1+$4_$2_map_processing/$1+$4_r2.sai ../mapped$2/$1+$4_$2_map_processing/$1+$4_mappable_R1.fastq ../mapped$2/$1+$4_$2_map_processing/$1+$4_mappable_R2.fastq  | $softdir/samtools view -Su -q $MAPQ -@ $threads - | $softdir/samtools sort -@ $threads -m $ram -T ../mapped$2/$1+$4_$2_map_processing/$1+$4_temp_PE -o ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_sorted.bam -
...
# samtools rmdup
$softdir/samtools rmdup -s ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_sorted.bam ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_rmdup.bam
$softdir/samtools rmdup ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_sorted.bam ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_rmdup.bam

# samtools merge
$softdir/samtools merge -@ $threads ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_rmdup.bam ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_rmdup.bam ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_rmdup.bam

# samtools index
$softdir/samtools index ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_sorted.bam
$softdir/samtools index ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_sorted.bam
$softdir/samtools index ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_rmdup.bam
$softdir/samtools index ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_rmdup.bam
...
merged_mapped="$($softdir/samtools idxstats ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_sorted.bam | awk 'BEGIN {a=0} {a += $3} END{print a}')"
PE_mapped="$($softdir/samtools idxstats ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_sorted.bam | awk 'BEGIN {a=0} {a += $3} END{print a}')"
merged_uniq="$($softdir/samtools idxstats ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_merged_rmdup.bam | awk 'BEGIN {a=0} {a += $3} END{print a}')"
PE_uniq="$($softdir/samtools idxstats ../mapped$2/$1+$4_$2_map_processing/$1+$4_$2_PE_rmdup.bam | awk 'BEGIN {a=0} {a += $3} END{print a}')"
