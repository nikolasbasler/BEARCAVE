...
$softdir/cutadapt -a AGATCGGAAGAGCACACGTC -O 1 -m $minlength -o ../trimdata/$1_processing/$2+$1_mappable.fastq ../trimdata/$1_processing/$2+$1_R1.fastq >> ../trimdata/$1_processing/$2+$1_trim_report.log
