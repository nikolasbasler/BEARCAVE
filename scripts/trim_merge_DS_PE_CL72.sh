...
../software/miniconda3/bin/cutadapt -u 5 -o ../trimdata/$1_processing/$2+$1_R1.fastq ../trimdata/$1_processing/$2+$1_R1_untrimmed.fastq >> ../trimdata/$1_processing/$2+$1_trim_report.log
